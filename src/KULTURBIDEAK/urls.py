...
urlpatterns = patterns('',
    ...
    #url(r'^login$', ob_views.admin.logina),
    url(r'^login$', ob_views.logina),
    #url(r'erregistratu$', ob_views.admin.erregistratu),
    ...
    #url(r'oaipmh_datubilketa',ob_views.harvest_views.oaipmh_datubilketa),
    #url(r'tsv_datubilketa',ob_views.harvest_views.tsv_datubilketa),
    ...
    #url(r'debug_solr_template',ob_views.admin.debug_solr_template),
